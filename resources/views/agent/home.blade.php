    ...
    {{-- @include('admin.include.sidebar-li') --}}
        {{-- <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                    <a href="{{ route('add.agent', ['school_uuid'=>session('school.uuid') ,'admin_uuid'=>Auth::user()->uuid]) }}"
                        class="nav-link">
                        <i class="far fa-circle nav-icon"></i>
                        <p>{{ __('admin.add agent') }}</p>
                    </a>
                </li>
            </ul>
        </li>
                                ...
                                <div class="card-body box-profile">
                                    <div class="text-center">
                                        <img class="profile-user-img img-fluid img-circle"
                                            ...
                                            src="{{ asset('img/'.Auth::user()->img->img) ?? asset('img/avatar1.jpg') }}" alt="User profile picture" />
                                    </div>
