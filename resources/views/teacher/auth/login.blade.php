...
<div class="login-box ">
    ...
    <div class="card">
        <div class="card-body login-card-body">
            <p class="login-box-msg">{{ __('lang.teacher') }}</p>
            @guest('teacher')
            <form method="POST" action="{{ route('teacher.login.seve') }}">
                @csrf
            ...
            <div class="card card-widget widget-user">
                ...
                <a href="{{ route('teacher.home') }}" class="btn btn-block btn-info mt-5">{{ __('lang.page.home') }}</a>
            </div>
            @endguest
