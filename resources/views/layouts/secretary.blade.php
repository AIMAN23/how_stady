        ...
        <div class="wrapper">
            ...
            <nav class="main-header navbar navbar-expand bg-a navbar-white navbar-light">
                ...
                <ul class="navbar-nav ml-auto">
                    @guest('secretary')
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('secretary.login') }}">{{ __('Login') }}</a>
                    </li>
                        @if (Route::has('secretary.register'))
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('secretary.register') }}">{{ __('Register') }}</a>
                        </li>
                        @endif
                    @else
                    <li class="nav-item dropdown user-menu">
                        ...
                        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right" style="left: inherit; right: 0px;">
                          ...
                          <li class="user-footer">
                            ...
                            <form id="logout-form" action="{{ route('secretary.logout') }}" method="POST" style="display: none;">
                                @csrf
                            </form>
