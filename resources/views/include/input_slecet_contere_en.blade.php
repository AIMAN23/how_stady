...
<!--   <label >
  ...
  <select  class="form-control custom-select" require> -->
      <option value="YE - Yemen">
        ...
        Antarctica
      </option><option value="AG - Antigua &amp; Barbuda">
        Antigua &amp; Barbuda
        ...
        Aruba
      </option><option value="AC - Ascension Island">
        Ascension Island
        ...
        Brazil
      </option><option value="IO - British Indian Ocean Terri">
        British Indian Ocean Territory
      </option><option value="VG - British Virgin Islands">
        ...
        Cape Verde
      </option><option value="BQ - Caribbean Netherlands">
        ...
        Comoros
      </option><option value="CG - Congo - Brazzaville">
        Congo - Brazzaville
      </option><option value="CD - Congo - Kinshasa">
        Congo - Kinshasa
        ...
        Ethiopia
      </option><option value="FK - Falkland Islands (Islas Ma">
        ...
        French Polynesia
      </option><option value="TF - French Southern Territorie">
        ...
        Haiti
      </option><option value="HM - Heard &amp; McDonald Islan">
        ...
        Mozambique
      </option><option value="MM - Myanmar (Burma)">
        Myanmar (Burma)
        ...
        Philippines
      </option><option value="PN - Pitcairn Islands">
        Pitcairn Islands
        ...
        San Marino
      </option><option value="ST - São Tomé &amp; Príncipe">
        São Tomé &amp; Príncipe
        ...
        South Africa
      </option><option value="GS - South Georgia &amp; South ">
        ...
        Sri Lanka
      </option><option value="BL - St. Barthélemy">
        St. Barthélemy
      </option><option value="SH - St. Helena">
        St. Helena
      </option><option value="KN - St. Kitts &amp; Nevis">
        St. Kitts &amp; Nevis
      </option><option value="LC - St. Lucia">
        St. Lucia
      </option><option value="MF - St. Martin">
        St. Martin
      </option><option value="PM - St. Pierre &amp; Miquelon">
        St. Pierre &amp; Miquelon
      </option><option value="VC - St. Vincent &amp; Grenadin">
        St. Vincent &amp; Grenadines
      </option><option value="SR - Suriname">
        Suriname
      </option><option value="SJ - Svalbard &amp; Jan Mayen">
        Svalbard &amp; Jan Mayen
        ...
        Tonga
      </option><option value="TT - Trinidad &amp; Tobago">
        Trinidad &amp; Tobago
      </option><option value="TA - Tristan da Cunha">
        Tristan da Cunha
        ...
        Turkmenistan
      </option><option value="TC - Turks &amp; Caicos Islands">
        Turks &amp; Caicos Islands
      </option><option value="TV - Tuvalu">
        Tuvalu
      </option><option value="UM - U.S. Outlying Islands">
        U.S. Outlying Islands
      </option><option value="VI - U.S. Virgin Islands">
        U.S. Virgin Islands
        ...
        Vanuatu
      </option><option value="VA - Vatican City">
        Vatican City
      </option><option value="VE - Venezuela">
        Venezuela
      </option><option value="VN - Vietnam">
        Vietnam
      </option><option value="WF - Wallis &amp; Futuna">
        Wallis &amp; Futuna
