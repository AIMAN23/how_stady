...
@section('main-header-li-left'){{-- @include('student.include.main-header-li-left') --}}@endsection
@section('main-header-li-right'){{-- @include('student.include.main-header-li-right') --}}@endsection
@section('sidebar-li'){{-- @include('student.include.sidebar-li') --}}@endsection


{{--  عنوان الصفحة:الصفحة الشخصية للمشرف --}}
@section('content-header')<h1>{{ __('student.Profile') }}</h1>@endsection
{{-- نهاية العنوان --}}
                ...
                <div class="card-header p-2">
                    <ul class="nav nav-pills">
                        <li class="nav-item"><a class="nav-link active" href="#Profile"
                                data-toggle="tab">{{ __('student.Profile') }}</a></li>
                        <li class="nav-item"><a class="nav-link" href="#About"
                                data-toggle="tab">{{ __('student.About Me') }}</a></li>
                        <li class="nav-item"><a class="nav-link" href="#settings"
                                data-toggle="tab">{{ __('student.setting') }}</a></li>
                    </ul>
                </div><!-- /.card-header -->
                <div class="card-body">
                                ...
                                <div class="card-body box-profile">
                                    ...
                                    <div class="card card-primary">
                                        <div class="card-header">
                                            <h3 class="card-title">{{ __('student.image') }}</h3>
                                        </div>
                                        <!-- /.card-header -->
                                        <div class="card-body">
