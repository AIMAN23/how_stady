...
@section('main-header-li-left'){{-- @include('manager.include.main-header-li-left') --}}@endsection
@section('main-header-li-right'){{-- @include('manager.include.main-header-li-right') --}}@endsection
@section('sidebar-li'){{-- @include('manager.include.sidebar-li') --}}@endsection


{{--  عنوان الصفحة:الصفحة الشخصية للمشرف --}}
@section('content-header')<h1>{{ __('manager.Profile') }}</h1>@endsection
{{-- نهاية العنوان --}}
                ...
                <div class="card-header p-2">
                    <ul class="nav nav-pills">
                        <li class="nav-item"><a class="nav-link active" href="#Profile"
                                data-toggle="tab">{{ __('supervisor.Profile') }}</a></li>
                        <li class="nav-item"><a class="nav-link" href="#About"
                                data-toggle="tab">{{ __('supervisor.About Me') }}</a></li>
                        <li class="nav-item"><a class="nav-link" href="#settings"
                                data-toggle="tab">{{ __('supervisor.setting') }}</a></li>
                    </ul>
                </div><!-- /.card-header -->
                <div class="card-body">
                                ...
                                <div class="card-body box-profile">
                                    <div class="text-center">
                                        <img class="profile-user-img img-fluid img-circle"
                                            ...
                                            src="{{ asset('Images/school/'.Auth::user()->school->logo )}}" alt="User profile picture" />
                                    </div>
                                    ...
                                    <p class="text-muted text-center">{{ __('lang.Manager') }}</p>

                                    <!-- About Me Box -->
                                    <div class="card card-primary">
                                        <div class="card-header">
                                            <h3 class="card-title">{{ __('manager.image') }}</h3>
                                        </div>
                                        <!-- /.card-header -->
                                        <div class="card-body">
