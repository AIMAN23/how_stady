            ...
            <div class="card">
                <div class="card-header p-2">
                    <ul class="nav nav-pills">
                        <li class="nav-item"><a class="nav-link {{ $tab_pane_1 ?? '' }}" href="#Profile"
                                data-toggle="tab">{{ __('admin.Profile') }}</a></li>
                        <li class="nav-item"><a class="nav-link {{ $tab_pane_2 ?? '' }}" href="#About"
                                data-toggle="tab">{{ __('admin.About Me') }}</a></li>
                        <li class="nav-item"><a class="nav-link {{ $tab_pane_3 ?? '' }}" href="#settings"
                ...
                <div class="card-body">
                    <div class="tab-content">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <output id="email" type="email"
                                                    ...
                                                    required autocomplete="email">{{ auth()->user()->email }}</output>
                                ...
                                <fieldset>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group required col-6 col-md-3" aria-required="true">
                                            ...
                                            <div class="elVal">
                                                {{--  --}}
                                                <input type="text" name="f_name" id="f_name" minlength="3"
                                                    maxlength="15"
                                        ...
                                        <div class="form-group required col-6 col-md-3" aria-required="true">
                                            ...
                                            <div class="elVal">
                                                {{--  --}}
                                                <input type="text" name="p_name" id="p_name" minlength="3"
                                                    maxlength="15"
                                        ...
                                        <div class="form-group required col-6 col-md-3" aria-required="true">
                                            ...
                                            <div class="elVal">
                                                {{--  --}}
                                                <input type="text" name="l_name" id="l_name" minlength="3"
                                                    maxlength="15"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group  col-6 col-md-4">
                                            ...
                                            <input id="street" type="text"
                                                ...
                                                value="{{old('street')?? auth::user()->address->street ?? '' }}"
                                        ...
                                        {{-- <div class="form-group  col-6 col-md-4">
                                                                                ...
                                                                                <input id="zip" type="number" class="form-control " value="{{old('zip')?? auth::user()->address->zip ?? '' }}"
                                        name="zip" placeholder="Zip Code" maxlength="6" min="0" tabindex="0">
                                    </div> --}}
                        </div>
                        </fieldset>
                                ...
                                <div class="form-group required col-md-6" aria-required="true">
                                    ...
                                    <div class="elVal">
                                        ...
                                        <input type="text" name="confirmation_email" id="confirmation_email"
                                            value="{{old('confirmation_email')?? auth::user()->email }}" maxlength="50"
                        ...
                        {{--  --}}
                        <input type="submit" name="seve" value="{{'حفظ البيانات' }}"
                            class="btn btn-sm btn-outline-primary">
                        {{--  --}}
                        <a class=" btn btn-sm btn-outline-primary" href="#Profile"
                            data-toggle="tab">{{ __('admin.Profile') }}</a>
