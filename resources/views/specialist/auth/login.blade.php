...
<div class="login-box ">
    ...
    <div class="card">
        <div class="card-body login-card-body">
            <p class="login-box-msg">{{ __('lang.specialist') }}</p>
            @guest('specialist')
            <form method="POST" action="{{ route('specialist.login.seve') }}">
                @csrf
            ...
            <div class="card card-widget widget-user">
                ...
                <a href="{{ route('specialist.home') }}" class="btn btn-block btn-info mt-5">{{ __('lang.page.home') }}</a>
            </div>
            @endguest
