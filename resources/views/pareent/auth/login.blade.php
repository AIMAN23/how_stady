...
<div class="login-box ">
    ...
    <div class="card">
        <div class="card-body login-card-body">
            <p class="login-box-msg">{{ __('lang.pareent') }}</p>
            @guest('pareent')
            <form method="POST" action="{{ route('pareent.login.seve') }}">
                @csrf
            ...
            <div class="card card-widget widget-user">
                ...
                <a href="{{ route('pareent.home') }}" class="btn btn-block btn-info mt-5 ">{{ __('lang.page.home') }}</a>
            </div>
