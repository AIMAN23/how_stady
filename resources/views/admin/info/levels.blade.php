                    ...
                    <div class="card card-primary">
                      <div class="card-header p-0">
                        <h4 class="card-title w-100">
                          <a data-toggle="collapse" data-parent="#accordion" href="#{{ $level_code.'item' }}"
                           class="level"
                          data-div="{{ $level_code.'x' }}" data-route="{{ route('get.classrooms', [ 'level_code'=>$level_code ] ) }}"
                          >
                      ...
                      <div id="{{ $level_code.'item' }}" class="panel-collapse collapse in">
                        <div id="body" class="card-body">
                          <p class="text-right" dir="rtl">{{ "مشرف المرحله :" }} {{ '.....' }}
                              <button 
                                data-toggle="modal"
                                data-target="#modal-level-edit" 
                                class="{{ 'level-supervisor ' }} btn btn-info btn-sm float-left"
                                data-route="{{ route('get.level.supervisor', [ 'level_code'=>$level_code ] ) }}"
                               >تعديل</button>
                          </p>
                          <div class="row">
