                ...
                <div class="col-md-12">
                  ...
                  <form method="POST" action="{{ route('admin.password.update',Auth::user()->id) }}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email')?? $email ?? Auth::user()->email }}" {{ 'disabled="disabled"' }} readonly required autocomplete="email">
