...
<div class="login-box ">
    ...
    <div class="card">
        <div class="card-body login-card-body">
            <p class="login-box-msg">{{ __('lang.financial') }}</p>
            @guest('financial')
            <form method="POST" action="{{ route('financial.login.seve') }}">
                @csrf
            ...
            <div class="card card-widget widget-user">
                ...
                <a href="{{ route('financial.home') }}" class="btn btn-block btn-info mt-5">{{ __('lang.page.home') }}</a>
            </div>
            @endguest
